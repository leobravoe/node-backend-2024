...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fornatto_db_2`.`Mesa` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fornatto_db_2`.`Pedido` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fornatto_db_2`.`TipoProduto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fornatto_db_2`.`Produto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fornatto_db_2`.`PedidoProduto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fornatto_db_2`.`Usuario` ;
...
START TRANSACTION;
USE `fornatto_db_2`;
INSERT INTO `fornatto_db_2`.`PedidoProduto` (`Pedido_id`, `Produto_id`, `precoVenda`, `quantidade`, `estadoValorAnulado`, `estadoPago`, `estadoCupomImpresso`, `estadoComandaImpressa`, `estadoRecebido`, `observacao`, `dataAtualizacao`, `dataCriacao`) VALUES (1, 1, 50.50, 1, 0, 0, 0, 0, 0, 'Adicional de Bacon', '2023-03-12 20:00:00', '2023-03-12 20:00:00');
INSERT INTO `fornatto_db_2`.`PedidoProduto` (`Pedido_id`, `Produto_id`, `precoVenda`, `quantidade`, `estadoValorAnulado`, `estadoPago`, `estadoCupomImpresso`, `estadoComandaImpressa`, `estadoRecebido`, `observacao`, `dataAtualizacao`, `dataCriacao`) VALUES (1, 2, 8.00, 1, 0, 0, 0, 0, 0, 'Sem açucar', '2023-03-12 20:00:00', '2023-03-12 20:00:00');
INSERT INTO `fornatto_db_2`.`PedidoProduto` (`Pedido_id`, `Produto_id`, `precoVenda`, `quantidade`, `estadoValorAnulado`, `estadoPago`, `estadoCupomImpresso`, `estadoComandaImpressa`, `estadoRecebido`, `observacao`, `dataAtualizacao`, `dataCriacao`) VALUES (2, 3, 8.00, 10, 0, 0, 0, 0, 0, NULL, '2023-03-12 20:00:00', '2023-03-12 20:00:00');
INSERT INTO `fornatto_db_2`.`PedidoProduto` (`Pedido_id`, `Produto_id`, `precoVenda`, `quantidade`, `estadoValorAnulado`, `estadoPago`, `estadoCupomImpresso`, `estadoComandaImpressa`, `estadoRecebido`, `observacao`, `dataAtualizacao`, `dataCriacao`) VALUES (2, 1, 50.50, 2, 0, 0, 0, 0, 0, NULL, '2023-03-12 20:00:00', '2023-03-12 20:00:00');
INSERT INTO `fornatto_db_2`.`PedidoProduto` (`Pedido_id`, `Produto_id`, `precoVenda`, `quantidade`, `estadoValorAnulado`, `estadoPago`, `estadoCupomImpresso`, `estadoComandaImpressa`, `estadoRecebido`, `observacao`, `dataAtualizacao`, `dataCriacao`) VALUES (3, 1, 50.50, 1, 0, 0, 0, 0, 0, NULL, '2023-03-12 20:00:00', '2023-03-12 20:00:00');
